...
import vn.hoangtung.jobhunter.domain.requert.ReqLoginDTO;
import vn.hoangtung.jobhunter.domain.dto.ResCreateUserDTO;
import vn.hoangtung.jobhunter.domain.dto.ResLoginDTO;
import vn.hoangtung.jobhunter.service.UserService;
import vn.hoangtung.jobhunter.util.SecurityUtil;
import vn.hoangtung.jobhunter.util.annotation.ApiMessage;
import vn.hoangtung.jobhunter.util.error.IdInvalidException;
...
public class AuthController {
        ...
        public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDto) {// https://stackoverflow.com/q/33663801
                ...
                // set cookies
                ResponseCookie resCookies = ResponseCookie // https://reflectoring.io/spring-boot-cookies/#:~:text=We%20can%20add%20all%20the%20properties%20that%20we%20need%20and%20use%20the%20method%20build()%20of%20the%20builder%20to%20create%20the%20ResponseCookie%3A
        ...
        public ResponseEntity<ResLoginDTO> logout() throws IdInvalidException {
                ...
                ResponseCookie deleteSpringCookie = ResponseCookie // https://reflectoring.io/spring-boot-cookies/#:~:text=We%20can%20add%20all%20the%20properties%20that%20we%20need%20and%20use%20the%20method%20build()%20of%20the%20builder%20to%20create%20the%20ResponseCookie%3A
